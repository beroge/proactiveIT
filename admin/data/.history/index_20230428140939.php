		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2" align="right">
					<button type="button" name="add" id="addRecord" class="btn btn-success">Add New Customer</button>
				</div>
			</div>
		</div>
		<table id="recordListing" class="table table-bordered table-striped">
			<thead>
				...
				<th>#</th>
					...
					<th>AutoPay</th>										
					<th>Amount</th>	
					<!-- Column width hack because adjusting width in js affects all colunm, temp because will write js targeting single column				 -->
					<th data-sortable="false">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Notes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>					
					<th data-sortable="false">ToS</th>					
					<th data-sortable="false">SLA</th>					
					<th>PWNED</th>					
    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						<div class="form-group"
							<label for="devid" class="control-label">Device ID</label>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="at" name="amount" placeholder="$">							
						</div>
						<div class="form-group">
